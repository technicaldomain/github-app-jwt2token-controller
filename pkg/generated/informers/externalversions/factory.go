...
type SharedInformerFactory interface {
	...
	Githubapp() githubappjwt2token.Interface
}

func (f *sharedInformerFactory) Githubapp() githubappjwt2token.Interface {
	return githubappjwt2token.New(f, f.namespace, f.tweakListOptions)
}
