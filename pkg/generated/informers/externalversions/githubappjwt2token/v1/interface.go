...
type Interface interface {
	// ArgoCDRepos returns a ArgoCDRepoInformer.
...
// ArgoCDRepos returns a ArgoCDRepoInformer.
func (v *version) ArgoCDRepos() ArgoCDRepoInformer {
	return &argoCDRepoInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
