...
type SecretInformer interface {
	...
	Lister() githubappjwt2tokenv1.SecretLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.GithubappV1().Secrets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GithubappV1().Secrets(namespace).Watch(context.TODO(), options)
			},
		},
		&apisgithubappjwt2tokenv1.Secret{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *secretInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisgithubappjwt2tokenv1.Secret{}, f.defaultInformer)
}

func (f *secretInformer) Lister() githubappjwt2tokenv1.SecretLister {
	return githubappjwt2tokenv1.NewSecretLister(f.Informer().GetIndexer())
}
